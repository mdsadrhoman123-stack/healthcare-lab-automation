...
<img src="assets/demo.gif" alt="Lab Result Automation: one execution running step by step, a step failing on purpose — held and escalated, in red — then that same step handled and the run completing" width="100%">

<p align="center">42 nodes · <b>6 failure paths, every one alerted</b> · 0 autonomous clinical decisions · held at Phase 0 validation</p>
...
<img src="assets/output.png" alt="Lab Result Automation: sample of the output a client receives, including one step that failed and what happened instead" width="100%">
